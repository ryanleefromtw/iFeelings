...
public class IndoorMap extends Fragment {
     ...
     * @return A new instance of fragment IndoorMap.
     */
    // TODO: Rename and change types and number of parameters
    public static IndoorMap newInstance(String param1, String param2) {
        IndoorMap fragment = new IndoorMap();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SVGMapView mapView = (SVGMapView) view.findViewById(R.id.indoor_mapView);

        mapView.loadMap(getResources(),R.raw.sample2);
        return view;
    }
